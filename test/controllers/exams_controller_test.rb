...
class ExamsControllerTest < ActionController::TestCase
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post :create, exam: { lecture_id: @exam.lecture_id, season: @exam.season, user_id: @exam.user_id, year: @exam.year }
    end
  ...
  test "should update exam" do
    patch :update, id: @exam, exam: { lecture_id: @exam.lecture_id, season: @exam.season, user_id: @exam.user_id, year: @exam.year }
    assert_redirected_to exam_path(assigns(:exam))
  end
